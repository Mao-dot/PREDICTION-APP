...
import { FutureAnimatedTitle } from '@/components/ui/future-animated-title';
import { FuturePortalBackground } from '@/components/ui/future-portal-background';
import {
...
export function BlackFuturePhone() {
  ...
  return (
    ...
    <FuturePortalBackground />

    <div
      className="signal-grid pointer-events-none fixed inset-0"
      aria-hidden="true"
    />
      {screen === 'setup' && (
        <SetupScreen
